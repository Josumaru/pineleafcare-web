    ...
    return (
        <div className="text-white">
            ...
            <div className="grid grid-cols-3 mt-3 ">
                <div className="container bg-[#18181B] rounded-2xl border-gray-500 border max-w-sm">
                    ...
                    <div className="flex items-center justify-center">
                        <button className="flex items-center justify-between bg-[#18181B] text-white px-4  mt-10 mb-10 rounded-full border border-gray-600 hover:bg-gray-700 transition">
